...
def  zapisVysledkyUspesnosti(labels,vektorUspesnosti):
    soubor = open('OBR_vysledky.txt','w')
...
def otestuj():
    ...
    tridy1,etalony1 = nactiTridyEtalonyZeSouboru('OBR_1.txt')
    tridy2,etalony2 = nactiTridyEtalonyZeSouboru('OBR_2.txt')
    tridy3,etalony3 = nactiTridyEtalonyZeSouboru('OBR_3.txt')
